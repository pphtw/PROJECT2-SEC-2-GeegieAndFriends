        ...
        <div class="grid grid-cols-12 gap-5 h-full">
          <div class="flex flex-col col-span-3">
            ...
            <div class="grow flex flex-col bg-[#E5E5E5] rounded-2xl h-[23rem]" >
              <div class="grow h-3/5 bg-cover rounded-t-2xl" :style="{'backgroundImage': 'url(' + encodeURI(currentTrack.cover) + ')'}"></div>
              <div
                  ...
                  <div class="repeat-track">
                    <button v-if="!repeat">
                      <svg width="20" height="20" viewBox="0 0 32 32" fill="none"
                           xmlns="http://www.w3.org/2000/svg" @click="playLoop">
                        <path d="M6.54398 6.88H23.2267C25.44 6.88 27.2267 8.66667 27.2267 10.88V15.3067" stroke="black"
                              stroke-opacity="0.7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path
                            ...
                            stroke="black" stroke-opacity="0.7" stroke-width="1.5" stroke-miterlimit="10"
                            stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M23.0133 29.3333L27.2267 25.12L23.0133 20.9067" stroke="black" stroke-opacity="0.7"
                    ...
                    <button v-else>
                      <svg  width="20" height="20" viewBox="0 0 32 32" fill="none"
                           xmlns="http://www.w3.org/2000/svg" @click="playLoop">
                        <path d="M6.54398 6.88H23.2267C25.44 6.88 27.2267 8.66667 27.2267 10.88V15.3067"
                              stroke="#C493E1" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path
                            ...
                            stroke="#C493E1" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round"/>
                        <path d="M23.0133 29.3333L27.2267 25.12L23.0133 20.9067" stroke="#C493E1" stroke-width="2.5"
