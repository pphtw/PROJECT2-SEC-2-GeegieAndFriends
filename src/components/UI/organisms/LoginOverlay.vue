...
<template>
  <Teleport to="body">
    <Transition>
      <div
        v-if="openLoginOverlay"
        class="absolute w-screen h-screen top-0 left-0 bg-gray-900/50 flex items-center justify-center px-5 py-5 z-[999]"
        @click.self="toggleLoginOverlay"
      >
        <div
          class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-h-[75%] bg-indigo-500"
          style="max-width: 1000px"
        >
          <div class="md:flex md:flex-row w-full h-full items-center relative">
            <TransitionGroup name="list">
              ...
              >
                ...
                <div class="w-full h-full flex flex-col">
                  <div class="text-center mb-10 h-fit">
                    ...
                    <div class="flex -mx-3">
                      <div class="w-full px-3 flex flex-col gap-4">
                        <div
                          ...
                          class="text-center"
                          :class="
                            isRegistered ? 'text-green-500' : 'text-red-500'
                          "
                        >
              ...
              <div class="order-2 md:block w-1/2 p-10 h-full">
                <svg
